...
namespace TheAudioDB
{
    ...
    public class Search
    {
        ...
        /// <returns><see cref="Data.TrackList" />TrackList</returns>
        public static TrackList TrackList(string artistName, string trackName, string apiKey = "")
        {
            ...
            var le = new LoggingArgs("Sites.TheAudioDB", "Search", "TrackList");
        ...
        public static TrackList Top10(string artistName, string apiKey = "")
        {
            ...
            var le = new LoggingArgs("Sites.TheAudioDB", "Search", "Top10");
            le.Parameters.Add(new Para("artistName", artistName));
            le.Parameters.Add(new Para("apiKey", apiKey));
            Logging.NewLogEntry(le);
        ...
        /// <param name="artistName">Artist</param>
        /// <param name="apiKey">ApiKey</param>
        /// <returns><see cref="Data.Artist" />Artist</returns>
        public static Artist Artist(string artistName, string apiKey = "")
        {
            ...
            var le = new LoggingArgs("Sites.TheAudioDB", "Search", "Artist");
            le.Parameters.Add(new Para("artistName", artistName));
            le.Parameters.Add(new Para("apiKey", apiKey));
            Logging.NewLogEntry(le);
            ...
            try
            {
               // ret.Data = Json.Deserialize<ArtistList>(Http.Request("http://www.theaudiodb.com/api/v1/json/" + apiKey + "/search.php?s=" + artistName)).List.System.Linq.FirstOrDefault() ?? new ArtistResult();
            }
            catch (Exception ex)
            {
                Exceptions.NewException(ex);
        ...
        /// <param name="artistName">Artist</param>
        /// <param name="apiKey">ApiKey</param>
        /// <returns><see cref="DiscographyList" />DiscographyList</returns>
        public static DiscographyList Discography(string artistName, string apiKey = "")
        {
            ...
            var le = new LoggingArgs("Sites.TheAudioDB", "Search", "Discography");
            le.Parameters.Add(new Para("artistName", artistName));
            le.Parameters.Add(new Para("apiKey", apiKey));
            Logging.NewLogEntry(le);
        ...
        /// <param name="apiKey">ApiKey</param>
        /// <returns><see cref="AlbumList" />AlbumList</returns>
        public static AlbumList Album(string artistName, string albumName, string apiKey = "")
        {
            ...
            var le = new LoggingArgs("Sites.TheAudioDB", "Search", "Album");
            le.Parameters.Add(new Para("artistName", artistName));
        ...
        /// <param name="tadbArtistId">TADB_Artist_ID</param>
        /// <param name="apiKey">ApiKey</param>
        /// <returns><see cref="VideoList" />VideoList</returns>
        public static VideoList Video(ArtistId tadbArtistId, string apiKey = "")
        {
            ...
            var le = new LoggingArgs("Sites.TheAudioDB", "Search", "Video");
            le.Parameters.Add(new Para("tadbArtistId", tadbArtistId.Id));
            le.Parameters.Add(new Para("apiKey", apiKey));
            Logging.NewLogEntry(le);
